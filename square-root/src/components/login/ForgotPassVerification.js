  ...
  return (
    <>
      ...
      <div className="base-container" ref={props.containerRef}>
        <Title title="Set new password" subtitle="Please enter the verification code sent to your email address below,
          your email address and a new password." style="forgot-title" />
