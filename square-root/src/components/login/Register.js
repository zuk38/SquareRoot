...
export function Register(props) {
  ...
  const { values, handleChange, errors, handleSubmit, handleDropDownChange } =
  ...
  return (
    <>
      {showModal && (
        <AuthModal
          title='Welcome!'
          subtitle='You have successfully registered a new account. We have sent you an email, please click on the confirmation link to verify your account'
          showModal={showModal}
