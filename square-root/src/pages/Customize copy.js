    ...
    return (
      <div>
          ...
          <button className="btn-orders"
                onClick={
                    this.openModal
            }><i class="fas fa-tasks fa-2x"></i>12{/*GET NUMBER OF ITEMS*/}<i class="fas fa-chevron-down"/></button>
            ...
            <Modal isOpen={
                ...
                className={"modal-orders"}>
                  ...
                  <h1 className="o-h1">Det er {/*GET ITEM NUMBERS*/} i {/*GET GREENSPACE NAME*/}</h1>
                      ...
                      <div className="modal-btns-footer">
                        <button className="orders-btn-close" onClick={this.closeModal} alt="Lukk">Lukk</button>
                        <button className="orders-btn-save" onClick={this.closeModal} alt="Lagre">Lagre</button>
                      </div>
                  </div>
                </Modal>
