...
class RainbedExample extends Component {
  state = {
    modalOpen: false,
    name: "",
    description: "",
    ...
    return (
      <div>
        <div className="greenspace">
          {data.Rainbed.map((rainbed, i) => {
            return (
              <div key={i}>
                <div className="greenspaceinfo">
                  <img src={rainbed.icon} className="img-greenspace" />
                  <div>
                    {" "}
                    {rainbed.roles.map(function(role, i) {
                      return (
                        <div key={i}>
                          <h5>{role.title}</h5>
                ...
                <div className="requirements">
                  <h5>{rainbed.city}</h5>
                  <div className="func">
                    <h4 className="h4">{rainbed.func}</h4>
                    <h4 className="h4">{rainbed.main}</h4>
                    <div className="func_info">
                      {rainbed.functions.map(function(func, i) {
                        return (
                          <div key={i}>
                    ...
                    <div className="main_info">
                      {rainbed.maintenance.map(function(main, i) {
                        return (
                          <div key={i}>
                ...
                <div className="description">
                  {rainbed.description.map(function(desc, i) {
                    return (
                      <div key={i}>
                        <div className="desc">
