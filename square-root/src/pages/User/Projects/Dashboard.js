                                    ...
                                    <div class="row">
                                        <div class="p-column left">
                                            <a href="/Projects" class="btn-back">
                                                <i class="fas fa-chevron-left"></i>Alle Prosjekter</a>
                                            <div class="menu-vertical">
                                                <a href="#" class="active">
                                                    <i class="fas fa-columns"></i>Dashbord</a>
                                                <a href="/Members">
                                                    <i class="fas fa-users"></i>Medlemmer</a>
                                                <a href="/Orders">
                                                    <i class="fas fa-tasks"></i>Bestillinger</a>
                                                <a href="/Settings">
                                                    <i class="fas fa-cog"></i>Innstillinger</a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="p-column right">
                                            ...
                                            <ul className="greensp-container">
                                                <li className="proj-col"><img src={project.project_img} className='project_img'/>{}</li>
