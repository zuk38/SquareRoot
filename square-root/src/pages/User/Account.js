                ...
                return(<div> {" "}
                   ...
                   < div className = "acc-title" > 
                    <h1 className="p-h1">Administrer Konto</h1>
                        ...
                        <fieldset>
                            ...
                            <div className="p-flex">
                                ...
                                <div className="p-classFlex">
                                    ...
                                    <input type="text" placeholder="Fornavn..." className="p-input-inline" pattern="[0-4]*"/>

                                </div>
                                <div className="p-classFlex">

                                    <input type="text" placeholder="Etternavn..." className="p-input-inline"/>
                                </div>
                            </div>
                        ...
                        <br/>
                        <button type="submit" name="btn-account">Lagre endringer</button>
                    </form></div>
