        ...
        <div>
            ...
            <div class="float-container-partner">
                ...
                <div class="float-child background-white width-60">
                    ...
                    <p className="partner-p">Er du en landskapsentreprenør eller eier av en Planteskole og interessert i SquareRoot?</p>
                    <form>
                        <fieldset>
                            ...
                            <label className="checkbox-container"><a href="terms-and-conditions">Jeg godtar vilkår og betingelser</a>
