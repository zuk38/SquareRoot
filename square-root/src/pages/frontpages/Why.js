    ...
    <div className="o-container">
      <div className="c-hero">
        ...
        <p className="c-txt--hero-p">
          For å skape bærekraftige byer med grøntområder er det både økonomisk
          og bærekraftig å velge ut de beste plantene for riktig sted.
          <br />
          <br />
          ...
          <div className="c-grid--founders">
            ...
            <div className="u-mrg--reset">
              <p className="c-txt-punchline--sm">
                ...
                mitigation, environmental policies and investment in low carbon
              ...
              <p>
                ...
                project called RainBrain has received funding from OrganiCity
                and SynchroniCity, both under the H2020 umbrella.
              </p>
              <p>
            ...
            <div className="u-mrg--reset">
              <p className="c-txt-punchline--sm">
                A lover of nature and the outdoors, Michel is passionate about
                the environment and contributing to solving climate change.
              </p>
              <p>
                He co-founded BiomimicryNorway, an NGO dedicated to educating
                people and companies about sustainable innovation inspired by
                nature. He has spent a great deal of energy helping various
                startups and initiatives in the past years using his many skills
                ranging from design to business modelling for Circular Economy.
              </p>
              <p>
                Amongst other things he has contributed building for Gruten the
                first norwegian urban farm growing mushrooms on coffee grounds.
                He is also involved with Pådriv on projects related to
