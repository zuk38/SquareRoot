                        ...
                        <p className="c-txt--hero-p">
                            ...
                            <h2 className="c-txt-punchline--sm c-mrg--top">
                                ...
                                <a href="https://edit.land/home">Edit Atelier</a>. Sammen
                                                  ...
                                                  eller for ønsket funksjonalitet, som overvannshåndtering.
                            </h2>
                            <br/>
                            ...
                            <h2 className="c-txt-punchline--sm c-mrg--top">
                                På plattformen vår kan disse konseptene bli lagt inn i prosjekter
                                              du selv oppretter og administrer. Herfra kan du velge å redigere
                                              hvilke planter som skal være med i et konsept, eller bestille det
                                              "as is". Du kan også velge ut planter enkeltvis og utvikle et eget
                                              konsept. Vi håndterer deretter bestillingen din og tar oss av
                                              kommunikasjonen med ulike planteskoler, og kommer tilbake til deg
                                              med et prisestimat og leveransetid, og legger til slutt din
                                              bestilling inn hos planteskolene.
                            </h2>
                        </p>
                    </div>
                </div>
            ...
            <div className="c-section o-container background-white">
                <div className="c-grid--2x3">
                    ...
                    <div className="grid-item2 u-mrg--txt1">
                        <img className="attachment-company_into" src="../images/relaxation-character.jpg"></img>
                    </div>
                    ...
                    <img className="attachment-company_into" src="../images/earth-plants.jpg"></img>
                    </div>
                    ...
                    <img className="attachment-company_into" src="../images/project-checklist.png"></img>
                    </div>
